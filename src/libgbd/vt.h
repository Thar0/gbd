...
#define VT_RGBFCOL_S(sf) VT_SGR("38;2;" sf)

#define VT_RGBCOL(rb, gb, bb, rf, gf, bf) VT_RGBCOL_S(#rb ";" #gb ";" #bb, #rf ";" #gf ";" #bf)

#define VT_RGBFCOL(rf, gf, bf) VT_RGBFCOL_S(#rf ";" #gf ";" #bf)

#define VT_RGB256COL(n) VT_SGR("38;5;" #n)
